...
public class MyXmlParser {
   SharedMemOut myshm;
    ...
    public void parseXML(NmapJobs job, String output){
        try {
            ...
            ,newextraportlist,newhostnames,newosclass,newosmatch,newuptimelist,newtcpseqlist,newipidlist,newtcptslist,job.getSa_hashkey(),job.getIdnmapjobs());
