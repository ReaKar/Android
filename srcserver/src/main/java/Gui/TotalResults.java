 ...
 */
     ...
     */
    public class TotalResults  extends JFrame implements ActionListener {
        /**
         *Gui class to show total results
         */
        ...
        public TotalResults(JTable table){
            this.table=table;
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(source.getText().equals("back")) {
                ...
                arr[0]=this.jtxfrom.getText();
                arr[1]=this.jtxto.getText();
                SaResults page=new SaResults(saname,new JTable(new DaoController().returnAllResutsDates(arr)));
                this.frame.dispose();
                page.runSaResults();
